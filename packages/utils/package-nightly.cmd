...
set CMAKE_OPT=^
	-D SIP_BINARY_PATH=%O4W_ROOT%/apps/Python36/Scripts/sip.exe ^
...
rem if not exist "%SETUPAPI_LIBRARY%" set SETUPAPI_LIBRARY=%PF86%\Windows Kits\8.0\Lib\win8\um\x64\SetupAPI.Lib
...
cmake -G "%CMAKEGEN%" ^
	...
	-D PYTHON_EXECUTABLE=%O4W_ROOT%/apps/Python36/python.exe ^
	...
	-D QCA_INCLUDE_DIR=%OSGEO4W_ROOT%\apps\Qt5\include\Qca-qt5\QtCrypto ^
